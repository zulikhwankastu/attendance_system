...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['logfiles'])) {
    foreach ($_FILES['logfiles']['tmp_name'] as $tmpFile) {
    ...
    $_SESSION['upload_date'] = date("Y-m-d");
    header("Location: report_folder.php");
    exit;
}
?>
...
<html>
<head>
    <title>Upload Attendance Logs</title>
    <link rel="stylesheet" type="text/css" href="upload.css">
</head>
<body class="upload-page">
    <div class="upload-container">
        <h2>📂 Choose Folder Containing Log Files</h2>
        <form method="POST" enctype="multipart/form-data">
            <label for="logfiles" class="file-label">Select Folder:</label><br><br>
            <!-- Folder picker -->
            <input type="file" id="logfiles" name="logfiles[]" webkitdirectory directory multiple required>
            <br><br>
